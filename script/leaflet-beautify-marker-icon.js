    ...
    L.BeautifyIcon = {
        ...
        Icon: L.Icon.extend({
            ...
            applyDefaults: function (options) {
                ...
                if (options) {
                    ...
                    if (!options.innerIconAnchor) {
                        ...
                        if (options.iconShape === 'circle' || options.iconShape === 'marker' || options.inconShape === 'triangle') {
            ...
            createIconInnerHtml: function () {
                ...
                if (options.iconShape === 'circle-dot' || options.iconShape === 'rectangle-dot' || options.iconShape === 'doughnut' || options.iconShape === 'triangle') {
                    return '';
                }
